...
- ✅ سامانه مودیان (صورتحساب الکترونیکی + شماره منحصر به فرد مالیاتی)
- ✅ مالیات بر ارزش افزوده و گزارش فصلی اظهارنامه
- ✅ گزارش معاملات فصلی ماده ۱۶۹ (خروجی TTMS)
- ✅ مالیات تکلیفی (اجاره و ماده ۸۶)
- ✅ ترازنامه، سود و زیان، دفاتر قانونی و استهلاک ماده ۱۴۹
- ✅ سیستم اقساط
- ✅ پیامک (FarazSMS)
- ✅ ربات تلگرام و بله
- ✅ تقویم شمسی (جلالی)
